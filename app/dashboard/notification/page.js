...
const Notification = () => {
  ...
  return (
    <div className="px-4 py-2 sm:px-6 lg:px-8">
      ...
      <div className="min-h-screen flex flex-col items-center" ref={formRef}>
        {academicYear !== "NA" ? (
          <>
            {userType === "superadmin" ? (
              <>
                                  ...
                                  {notification?.map((list, i) => (
                                    <tr key={i}>
                                      ...
                                      <td className="whitespace-nowrap px-3 py-4 text-sm">
                                        <span
                                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${list?.status === "Dispatch"
                                      ...
                                      <td className="whitespace-nowrap px-3 py-4 text-sm flex flex-col sm:flex-row gap-2 justify-start sm:justify-end font-medium">
                                        ...
                                        <button
                                          className={`px-2 py-1 rounded-lg text-white ${list?.status === "Dispatch"
